...
public class IngredientEndpoint
{
   ...
   {
      final List<Ingredient> results = em.createQuery("SELECT i FROM Ingredient i LEFT JOIN FETCH i.tPlant LEFT JOIN FETCH i.tHoney LEFT JOIN FETCH i.tSubstance LEFT JOIN FETCH i.tVirtues LEFT JOIN FETCH i.tPrescriptions LEFT JOIN FETCH i.tDefects", Ingredient.class).getResultList();
      return results;
   }
