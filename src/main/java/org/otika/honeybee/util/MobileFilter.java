...
/**
 * Servlet Filter implementation class MobileFilter
 */
@WebFilter(urlPatterns = { "/home", "/index.xhtml", "/index", "/" })
public class MobileFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res,
		...
		if (request.getHeader("User-Agent").indexOf("Mobile") != -1 || request.getHeader("User-Agent").indexOf("Nokia") != -1) {
			...
			if (session != null) {
				System.out.println("Mobile Session created at: "
		...
		/*
		 * String ua = req.getHeader("User-Agent").toLowerCase(); if
		 * (ua.matches(
		 ...
		 * )) { resp.sendRedirect("/mobile/motika.jsf"); return; }
		 */
