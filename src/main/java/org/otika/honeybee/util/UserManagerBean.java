...
public class UserManagerBean implements Serializable {
    ...
    public String logout() {
        try {
            ...
            Logger.getLogger(getClass().getName()).log(Level.ALL, "{0} : {1}", new Object[]{ex.getMessage(), ex.getCause().getMessage()});
    ...
    public String getUserPrincipal() {
        try {
            ...
            Logger.getLogger(getClass().getName()).log(Level.FINEST, "{0} - CAUSE : {1}", new Object[]{e.getMessage(), e.getCause()});
